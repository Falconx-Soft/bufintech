# Generated by Django 3.2.6 on 2022-03-04 22:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('Language', models.CharField(max_length=50)),
                ('Product', models.CharField(blank=True, default='none', max_length=1000)),
                ('Market', models.CharField(choices=[('public', 'Public'), ('private', 'Private')], default='public', max_length=1000)),
                ...
                ('Podcast', models.CharField(blank=True, max_length=1000)),
            ],
            options={
